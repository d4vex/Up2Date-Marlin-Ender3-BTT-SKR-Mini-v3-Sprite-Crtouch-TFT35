...
#define STRING_CONFIG_H_AUTHOR "(David Vodak, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.1359
    #define DEFAULT_Ki   2.0062
    #define DEFAULT_Kd  40.9871
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 422.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35.5, -49.5, -0 }
...
#define LCD_BED_TRAMMING
  ...
  #if ENABLED(BED_TRAMMING__USE_PROBE)
